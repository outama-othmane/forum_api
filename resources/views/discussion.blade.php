...
<div class="content">
    ...
    <div class="badge" style="color: #fff; margin: 0">{{ $discussion->channel->name }}</div>
</div>
</div>
<hr/>
<div>
    @foreach($discussion->posts as $post)
        <div class="discussion">
            <div class="avatar">
                <a href="#">
                    <img src="{{ $post->user->avatar }}" alt="avatar" title="{{ $post->user->name }}" />
                </a>
            </div>
            <div class="content">
                <h4>
                    {{ $post->user->name }} &mdash; {{ $post->id }}
                </h4>
                <div>
                    <p>
                        {{ $post->content }}
            ...
            <div class="meta">
                ...
                LIKED : <?php if($post->isLiked()): ?> YES <?php endif; ?>
            </div>
        </div>
        <hr />
    @endforeach
